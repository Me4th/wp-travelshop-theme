		...
		public function __construct( $settings_file = null, $option_group = false ) {
			...
			if ( $settings_file ) {
				if ( ! file_exists( __DIR__.'/'.$settings_file ) ) {
				    echo 'error: can not find file '.$settings_file;
					return;
				}

				require_once __DIR__.'/'.$settings_file;
			...
			$this->options_path = get_stylesheet_directory().'/admin-settings/';
			$this->options_url  = get_stylesheet_directory_uri().'/admin-settings/';
