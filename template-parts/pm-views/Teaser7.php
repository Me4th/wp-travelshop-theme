...
<section class="wishlist-item">
    ...
    <div class="wishlist-item-data">
        ...
        <span class="price">
            <div class="timestamp">
                <strong>Besucht:</strong><br />
                <?php echo Template::render(APPLICATION_PATH.'/template-parts/micro-templates/date-to-relative-string.php', [ 'timeStamp' => floor(intval($args['timestamp']) / 1000)]); ?>
            </div>
            <a href="<?php echo $args['url'] ; ?>">
                <?php
