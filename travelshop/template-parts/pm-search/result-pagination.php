            ...
            <nav aria-label="">
                <ul class="ajax-enabled-pagination pagination">
                    ...
                    <li class="page-item<?php echo ($current_page == 1) ? ' disabled' : ''; ?>">
                        <a class="page-link"
                           href="?action=search&<?php echo BuildSearch::getCurrentQueryString($current_page - 1, $page_size); ?>">
                    ...
                    <li class="page-item<?php echo ($current_page == $pages) ? ' disabled' : ''; ?>"><a
                                class="page-link"
                                href="<?php echo ($current_page >= $pages) ? '#' : '?action=search&' . BuildSearch::getCurrentQueryString($current_page + 1, $page_size); ?>">
