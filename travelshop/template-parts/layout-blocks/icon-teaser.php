<section class="content-block content-block-teaser-group">
    <div class="row">
        <div class="col-12">
            ...
            <p>
                Diese Teaser sind aktuell hardcoded in der Startseite eingefügt und dienen nur als Beispiel.
                Wir haben hier bewusst keinen Icon-Webfont eingefügt sondern arbeiten mit SVG Icons um die Performance
                zu erhöhen.
                Die Icons kann man natürlich schöner machen!
                <br>
                <span class="small">Template:
                    wp-content/themes/travelshop/template-parts/layout-blocks/icon-teaser.php</span>
            </p>
        </div>
        ...
        <div class="col-12 col-sm-6 col-lg-3">
            <article class="teaser icon-teaser">
                <div class="teaser-icon">
                    <div class="icon-inner icon-inner-primary">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-bell" width="52"
        ...
        <div class="col-12 col-sm-6 col-lg-3">
            <article class="teaser icon-teaser">
                <div class="teaser-icon">
                    <div class="icon-inner icon-inner-secondary">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-headset" width="52"
                            height="52" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none"
                            stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" />
        ...
        <div class="col-12 col-sm-6 col-lg-3">
            <article class="teaser icon-teaser">
                <div class="teaser-icon">
                    <div class="icon-inner icon-inner-primary">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-thumb-up" width="52"
                            height="52" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none"
                            stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" />
                            <path
