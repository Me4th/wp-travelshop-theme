                                ...
                                <nav>
                                    <ul class="pagination">
                                        ...
                                        <li  class="page-item <?php if ( $paged == 1 ) { echo 'disabled'; } ?>">
                                            <a href="<?php echo get_permalink( get_the_ID() ) . $prev_page_str; ?>" class="page-link">
                                        ...
                                        for ( $i = 1; $i <= $the_query->max_num_pages; $i++ ) {
                                            ...
                                            ?>
                                                <li class="page-item <?php echo $pager_active_class; ?>">
                                                    <a href="<?php echo get_permalink( get_the_ID() ); ?>page/<?php echo $i; ?>" class="page-link "><?php echo $i; ?></a>
                                        ...
                                        <?php if ( $the_query->max_num_pages > 1 ) { ?>
                                            ...
                                            ?>
                                        <li  class="page-item <?php if ( $paged == $the_query->max_num_pages ) { echo 'disabled'; } ?>">
                                            <a href="<?php echo get_permalink( get_the_ID() ); ?>page/<?php echo $next_page; ?>" class="page-link">
