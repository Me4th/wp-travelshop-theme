...
class TsInfoTeaser extends FLBuilderModule {
    ...
    public function __construct() {
        parent::__construct(array(
            'name'            => __( 'Info Teaser', 'fl-builder' ),
            'description'     => __( 'Info Teaser Element', 'fl-builder' ),
            'category'        => __( 'Custom content teaser', 'fl-builder' ),
            'group'        => __( 'Travelshop', 'fl-builder' ),
            'editor_export'   => false,
            'partial_refresh' => true,
            'icon'            => 'star-filled.svg',
            'dir'           => BB_MODULE_TS_DIR . 'modules/ts-info-teaser/',
            'url'           => BB_MODULE_TS_URL . 'modules/ts-info-teaser/',
        ));
    }
 ...
 */
FLBuilder::register_module('TsInfoTeaser', array(
            ...
            'common'    => array(
                ...
                'fields' => array(
                    ...
                    'teasers'     => array(
                        ...
                        'form'          => 'ts-info-teaser-form', // ID from registered form below
...
FLBuilder::register_settings_form('ts-info-teaser-form', array(
    'title' => __('Teaser', 'fl-builder'),
    'tabs'  => array(
        'general'      => array( // Tab
