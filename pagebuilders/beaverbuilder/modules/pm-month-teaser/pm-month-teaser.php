...
class TSPMMonthTeaser extends FLBuilderModule {
    ...
    public function __construct() {
        parent::__construct(array(
            'name'            => __( 'MonthTeaser', 'fl-builder' ),
            'description'     => __( 'Month based teasers, with random images', 'fl-builder' ),
            'category'        => __( 'pressmind Travel Calendar', 'fl-builder' ),
            'group'        => __( 'Travelshop', 'fl-builder' ),
            'editor_export'   => false,
            'partial_refresh' => true,
            'icon'            => 'editor-table.svg',
            'dir'           => BB_MODULE_TS_DIR . 'modules/pm-month-teaser/',
            'url'           => BB_MODULE_TS_URL . 'modules/pm-month-teaser/',
        ));
    }
 ...
 */
FLBuilder::register_module('TSPMMonthTeaser', array(
